...
describe('Telemetry', () => {
  ...
  describe('Disabling telemetry', () => {
    describe('sending the option and being a sponsor', () => {
      const getTelemetry = () => new Telemetry({ core, useTelemetry: false, isSponsor: true });
    ...
    describe('sending the option but not being a sponsor', () => {
      const getTelemetry = () => new Telemetry({ core, useTelemetry: false, isSponsor: false });
  ...
  describe('.error', () => {
    const getTelemetry = () => new Telemetry({ core, useTelemetry: true });
